...
from decoder import RRGDecoder



class ChestXrayMRG(nn.Module):
    def __init__(
            self, 
            d_model: int = 512,
            # CNN encoder
...
#     texts          = [
#         "Patient with shortness of breath, history of COPD",
#         "",
#         "Evaluate for pneumonia",
#         "",
#     ]
#     report_ids     = torch.randint(1, 1000, (B, 64)).to(device)
...
#     with torch.no_grad():
#         report = model(images, texts, report_ids)
#         print(report.shape)
