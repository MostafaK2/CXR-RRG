...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("logs/captioner_train.log", mode='w')    # save to file
    ]
)
logger = logging.getLogger()


# --------------------- Parsing Arguments -------------------------  COPY AND EDIT
def get_args():
...
DEFAULT = os.path.join(_find_root(), 'configs', 'captioner-conf', 'main.yml')
...
def main(): 
    ...
    hp   = ckpt['hyperparams']
    model = ChestXrayReportGenerator(**hp).to(DEVICE)
    ...
    temp_log = "/home/grad/masters/2025/mkamal/mkamal/cxr_report_gen/logs/captioner_train.log"
